...
Cluster API and its wider usage were explored by Michele Gazzetti and Michele Tagliani. They demonstrated how Cluster API and Metal3 streamline bare-metal Kubernetes cluster management, and proposed extending the Cluster API to manage non-Kubernetes hosts as well. By leveraging  [Virtual Kubelet](https://virtual-kubelet.io/docs/), the speakers presented a proof of concept showing how a Cluster API Bootstrap Provider could unify management across diverse environments. If you want to explore or support their efforts, take a look at the [GitHub repo](https://github.com/IBM/cluster-api-bootstrap-virtual-kubelet).
